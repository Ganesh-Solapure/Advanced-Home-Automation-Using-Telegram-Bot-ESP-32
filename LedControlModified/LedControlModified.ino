...
void setup() {
  ...
  // Set WiFi to station mode and disconnect from an AP if it was Previously connected Sadbhs Stars
  WiFi.mode(WIFI_STA);
  WiFi.disconnect();
  delay(100);
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (bot.messages[i].type ==  F("callback_query")) {
      ...
      if (text == F("/options")) {
        ...
        String keyboardJson = F("[[{ \"text\" : \"ON1\", \"callback_data\" : \"ON1\" },{ \"text\" : \"OFF1\", \"callback_data\" : \"OFF1\" },{ \"text\" : \"ON2\", \"callback_data\" : \"ON2\" },{ \"text\" : \"OFF2\", \"callback_data\" : \"OFF2\" },{ \"text\" : \"ON3\", \"callback_data\" : \"ON3\" },{ \"text\" : \"OFF3\", \"callback_data\" : \"OFF3\" },{ \"text\" : \"ON4\", \"callback_data\" : \"ON4\" },{ \"text\" : \"OFF4\", \"callback_data\" : \"OFF4\" },],");
        keyboardJson += F("[{ \"text\" : \"ON5\", \"callback_data\" : \"ON5\" },{ \"text\" : \"OFF5\", \"callback_data\" : \"OFF5\" },{ \"text\" : \"ON6\", \"callback_data\" : \"ON6\" },{ \"text\" : \"OFF6\", \"callback_data\" : \"OFF6\" },{ \"text\" : \"ON7\", \"callback_data\" : \"ON7\" },{ \"text\" : \"OFF7\", \"callback_data\" : \"OFF7\" },{ \"text\" : \"ON8\", \"callback_data\" : \"ON8\" },{ \"text\" : \"OFF9\", \"callback_data\" : \"OFF9\" }]]");
        bot.sendMessageWithInlineKeyboard(chat_id, "HOME AUTOMATION", "", keyboardJson);
      }
