...
#define BOTtoken "6158442821:AAE_H7kh54e2XdpFmCMNvLH0VkAksmz_F5U" //  Telegram Token
...
void setup() {
  ...
  pinMode(12, OUTPUT); // initialize digital ledPin as an output.
  delay(10);
  digitalWrite(relay1, HIGH); // initialize pin as off

  pinMode(13, OUTPUT); // initialize digital ledPin as an output.
  delay(10);
  digitalWrite(relay2, HIGH); // initialize pin as off

  pinMode(14, OUTPUT); // initialize digital ledPin as an output.
  delay(10);
  digitalWrite(relay3, HIGH); // initialize pin as off

  pinMode(27, OUTPUT); // initialize digital ledPin as an output.
  delay(10);
