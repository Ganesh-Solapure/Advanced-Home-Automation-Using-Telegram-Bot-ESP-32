...
String buttons[17] = { "LED1","LED2" ,"LED3","LED4" ,"LED5","LED6","LED7","LED8" ,"LED9","LED10","FAN","Cooler" ,"Lock Door","UnLock Door","Open Window","Close Window","AC"};  
int pin[17] = { 13,12,14,27 ,26,25,33,32 ,15,2,4,5,18 ,19,21,22,23};                      
