...
#define BOTtoken "6158442821:AAE_H7kh54e2XdpFmCMNvLH0VkAksmz_F5U"  // Bot token in the xxxxx format: xxxxxxxxxxxxxxx, start a conversation with the bot "BotFather" in Telegram and,
                                            // follow the instructions to create a new bot. You will be given a secret token. Do not tell it to anyone.
char ssid[] = "M113";         // Wifi SSID 
char password[] = "wifi8889";     // Wifi Password
String buttons[16] = { "Door Lock/UnLock","Feed Pet","LED1","LED2" ,"LED3","LED4","LED5","LED6"  ,"LED7","LED8","LED9","LED10" ,"LED11","LED12","All off" ,"FAN On/Off"};  
