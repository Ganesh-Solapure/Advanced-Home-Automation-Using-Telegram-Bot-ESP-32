  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (bot.messages[i].type ==  F("callback_query")) {
      ...
      if (text == F("/options1")) {
        ...
        String keyboardJson = F("[[{ \"text\" : \"ON0\", \"callback_data\" : \"ON0\" },{ \"text\" : \"OFF0\", \"callback_data\" : \"OFF0\" }],");
      ...
      if (text == F("/start")) {
        ...
        bot.sendMessage(chat_id, "/options1 : returns  /options2 inline /options3  /options4 keyboard\n", "Markdown");
      }
